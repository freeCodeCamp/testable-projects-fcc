...
export default function createPortfolioTests() {
  ...
  describe('#Portfolio tests', function() {
    ...
    describe('#Content', function() {
      ...
      it(`2. The welcome section should have an h1 element that contains text.`,
      function() {
      ...
      class of "project-tile" to hold a project.`,
      function() {
        FCC_Global.assert.isAbove(
      ...
      it(`6. My portfolio should have a navbar with an id of \"navbar\".`,
      function() {
    ...
    describe('#Layout', function() {
      ...
      it(`1. My portfolio should have at least one media query.`,
      function() {
        let queryRules = [];
      ...
      it(`3. The navbar should always be at the top of the viewport.`,
      function(done) {
        const navbar = document.getElementById('navbar');
