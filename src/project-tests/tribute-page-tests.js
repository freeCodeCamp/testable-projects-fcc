...
export default function createTributePageTests() {
  ...
  describe('#Tribute Page tests', function() {
    ...
    describe('#Content', function() {
      ...
      it(`3. I should see a <div> element with corresponding id="img-div".`,
        function() {
    ...
    describe('#Layout', function() {
      ...
      it(`1. The <img> element should responsively resize, relative to the width
        ...
        function() {
          ...
          FCC_Global.assert.notStrictEqual(
            maxWidthValue,
            'none',
      ...
      it(`2. The <img> element should be centered within its parent element.`,
        function() {
          const img = document.getElementById('image'),
