...
export default function createMarkdownPreviewerTests() {
    ...
    describe('Markdown Previewer tests', function() {
        ...
        describe('#Tests', function() {
            ...
            it('3. When I enter GitHub flavored markdown into the #editor element, the text is rendered as ' +
                'HTML to #preview as I type (Hint: You don\'t need to parse Markdown yourself - you can ' +
                'import the Marked library for this: https://cdnjs.com/libraries/marked).',
                function() {
                    triggerChange('');
            ...
            it('6. When my markdown previewer first loads, the default markdown in the #editor field ' +
            ...
            it('7. OPTIONAL BONUS: When I click a link rendered by my markdown previewer, the link is ' +
                'opened up in a new tab (HINT: read the Marked.js docs for this one!).',
                function() {
            ...
            it('8. OPTIONAL BONUS: My markdown previewer interprets carriage returns and renders ' +
                'them as line break.',
                function() {
