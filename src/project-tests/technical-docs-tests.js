...
export default function createTechnicalDocsPageTests() {
  ...
  function() {
    describe('#Content', function() {
      ...
      it(`2. Within the #main-doc ( <main> ) element, I can see several
      ...
      function() {
        ...
        FCC_Global.assert.strictEqual(typeQty.length,
          classQty,
      ...
      it(`3. The first element within each .main-section should be a <header>
      ...
      it(`4. Each <section> element with the class of "main-section" should
      also have an id that corresponds with the text of each <header> contained
      within it. Any spaces should be replaced with underscores (e.g. The
      <section> that contains the header "Javascript and Java" should have a
      ...
      it(`5. The .main-section elements should contain at least 10 <p> elements
      total (not each).`,
      function() {
        FCC_Global.assert.isAtLeast(
      ...
      it(`6. The .main-section elements should contain at least 5 <code>
      ...
      it(`7. The .main-section elements should contain at least 5 <li> items
      total (not each).`,
      function() {
        FCC_Global.assert.isAtLeast(
      ...
      it('8. I can see a <nav> element with a corresponding id="navbar".',
      function() {
        FCC_Global.assert.isNotNull(
      ...
      it(`9. The navbar element should contain one <header> element which
      ...
      it(`10. Additionally, the navbar should contain link (<a>) elements with
      the class of "nav-link". There should be one for every element with the
      class "main-section".`,
      function() {
      ...
      it(`11. The <header> element in the navbar must come before any link (<a>)
      ...
      it(`12. Each element with the class of "nav-link" should contain text that
      corresponds to the <header> text within each <section> (e.g. if you have
      a "Hello world" section/header, your navbar should have an element which
      ...
      function() {
        ...
        FCC_Global.assert.strictEqual(remainder.length,
          0,
      ...
      it(`13. When I click on a navbar element, the page should navigate to the
      corresponding section of the "main-doc" element (e.g. If I click on a
      "nav-link" element that contains the text "Hello world", the page
    ...
    describe('#Layout', function() {
      it(`1. On regular sized devices (laptops, desktops), the element with
      id="navbar" should be shown on the left side of the screen and should
