    ...
    describe('Technical Documentation Page tests', function() {
        describe('#Content', function() {
            ...
            it('9. The navbar element should contain one <header> element which contains text that describes the topic ' +
                ...
                function() {
                    FCC_Global.assert.strictEqual(document.getElementById('navbar').getElementsByTagName('header').length, 1, 'The navbar ' +
                        'element should contain only one <header> element.');
                });
            ...
            it('11. The <header> element in the navbar must come before any link (<a>) elements in the navbar.',
                function() {
                  ...
                  FCC_Global.assert.strictEqual(allAbove, true, 'The <header> element contained by the navbar must be come before ' +
