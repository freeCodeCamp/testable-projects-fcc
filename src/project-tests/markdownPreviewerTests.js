    ...
    describe('#Tests', function() {
      ...
      it('5. When my markdown previewer first loads, the default text in the #editor field should ' +
        'contain valid markdown that represents at least one of each of the following elements: ' +
         ...
         'item, a blockquote, an image, and bolded text.', function() {
      ...
      it('7. OPTIONAL BONUS: When I click a link rendered by my markdown previewer, the link is ' +
         'opened up in a new tab (HINT: read the Marked.js docs for this one!).', function() {
