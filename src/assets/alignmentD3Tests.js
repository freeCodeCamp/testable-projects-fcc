...
var isFeatureAligned = function(featureCoord, axis, tickPxCur, tickPxNext) {
  ...
  // (inclusive) the two ticks' axis coordinates.
  return featureCoord >= minTickCoord && featureCoord <= maxTickCoord
};
...
var getXFeatureCoord = function(feature) {
  return parseFloat(feature.getAttribute('cx') - 0.5);
};
...
var getYFeatureCoord = function(feature) {
  return parseFloat(feature.getAttribute('cy') - 0.5);
};
